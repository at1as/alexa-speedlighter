...
def get_welcome_response():
  ...
  card_title    = "Welcome"
  speech_output = "Welcome to the Speedlighter feed. Ask me for the latest blog post"
  reprompt_text = "Ask me what's the latest blog post"
...
def get_recent_posts(intent, session):
  session_attributes = {}
  print("The dict is: " + str(intent['slots']))
  ...
  return build_response(session_attributes,
                        build_speechlet_response(intent['name'], speech_output, reprompt_text, should_end_session))
